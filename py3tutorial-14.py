...
#game_size = 3
'''
# Approach for dynamically printing "   0  1  2"
s = " "
...
'''
# One line code for the thing doing above
...
'''
# Approach for making the game dynamic
g = []
...
'''
'''
# Shorter approach for above thing
g = [[0 for i in range(g_s)] for i in range(g_s)]
print(g)
'''